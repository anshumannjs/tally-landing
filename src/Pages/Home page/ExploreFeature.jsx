...
export default function ExploreFeature() {
  return (
    <div className='w-full text-center bg p-5'>
...
Glassball's Advanced Algoritham, reads your pre-existing lables & Auto-suggests labels, saving your time on Labelling and ability to apply it to ledgers in Bulk
      ...
      <div className='flex mt-5 flex-col md:flex-row space-y-10 md:space-y-0 md:space-x-4 px-3'>
        <CardType1 color='bg-cyan-300' icon={<DataSaverOffIcon className='mx-auto' />} title={'Connect your Tally'} para={'Connect your system tally and get all Companies, Ledgers & vouchers with just a click'} />
        <CardType1 color='bg-yellow-300' icon={<SecurityIcon className='mx-auto' />} title={'Import your Statements'} para={'Import any bank Statement against your company. We support 20+ major Bank Statements'} />
        ...
        <CardType1 color='bg-pink-300' icon={<PsychologyIcon className='mx-auto' />} title={'Submit & Sync'} para={'All your Labelling, gets synced to Tally as Ledgers with a just a click'} />
      </div>
    </div>
  )
}
