...
export default function TermsCondition() {
    return (
        <div>
            ...
            <p>These Terms will be governed by and interpreted in accordance with the laws of Hong Kong, and you submit to the non-exclusive jurisdiction of the state and federal courts located in Hong Kong for the resolution of any disputes.</p>
            <button><a href="https://codepen.io/onteronp/full/LyvNEd">Cancel</a></button><br />
            <button><a href="https://codepen.io/onteronp/full/aWxgpP">I Agree to the Terms and Conditions</a></button>
        </div>
    )
}
